...
export const V1_DATA_QUERY = gql`
  query moonwalkerswap($date: Int!, $date2: Int!) {
    current: moonwalkerswap(id: "1") {
      totalVolumeUSD
      totalLiquidityUSD
      txCount
    }
    oneDay: moonwalkerswapHistoricalDatas(where: { timestamp_lt: $date }, first: 1, orderBy: timestamp, orderDirection: desc) {
      totalVolumeUSD
      totalLiquidityUSD
      txCount
    }
    twoDay: moonwalkerswapHistoricalDatas(
...
export const GLOBAL_CHART = gql`
  query moonwalkerswapDayDatas($startTime: Int!, $skip: Int!) {
    moonwalkerswapDayDatas(first: 1000, skip: $skip, where: { date_gt: $startTime }, orderBy: date, orderDirection: asc) {
      id
      date
      totalVolumeUSD
      dailyVolumeUSD
...
export const GLOBAL_DATA = (block) => {
  const queryString = ` query moonwalkerswapFactories {
      moonwalkerswapFactories(
